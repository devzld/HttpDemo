package com.zld.netlib;

import android.content.Context;
import android.support.annotation.CheckResult;

import com.zld.netlib.interfaces.HeadersInterceptor;
import com.zld.netlib.interfaces.ParamsInterceptor;
import com.zld.netlib.utils.OkhttpProvidede;
...
//            }
            ...
            if (!checkNULL(baseUrl)) {
                ...
                builder.baseUrl("http://expample.com");
            }
